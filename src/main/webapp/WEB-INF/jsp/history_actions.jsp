...
<%
    ...
    Number catalog[] = (Number[])request.getAttribute(Constants.PerformedActions.CATALOGS_ACTION);
...
if(localStorage.getItem('getCatalogs')==null){
    localStorage.setItem('getCatalogs', 'false');
}
...
var getCatalogs = localStorage.getItem('getCatalogs')==='true';
                ...
                events: {
                    legendItemClick: function(event) {
                        ...
                        if(event.target.index==2){
                            localStorage.setItem('getCatalogs', !series[2].visible);
                        }
