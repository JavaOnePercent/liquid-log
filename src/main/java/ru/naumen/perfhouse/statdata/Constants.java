...
public class Constants
{
    ...
    public static class PerformedActions
    {
        ...
        static List<String> getProps()
        {
            return Lists.newArrayList(TIME, ADD_ACTIONS, EDIT_ACTIONS, CATALOGS_ACTION, LIST_ACTIONS, COMMENT_ACTIONS, ACTIONS_COUNT,
                    GET_FORM_ACTIONS, GET_DT_OBJECT_ACTIONS, SEARCH_ACTIONS); //новое действие
        }
